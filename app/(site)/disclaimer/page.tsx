...
export const metadata: Metadata = {
  title: "Disclaimer — BRO444 Game (Pakistan promos & editorial)",
  description:
    "BRO444 disclaimer: marketing copy here is context only — live bonuses, turnover, and payout rules live in the cashier. Real-money loss possible; rogue APK mirrors disclaimed.",
  alternates: { canonical: "/disclaimer" },
  openGraph: {
    title: "Disclaimer — BRO444 Game",
    description:
...
export default function DisclaimerPage() {
  return (
    <InnerPageShell
      path="/disclaimer"
      metaName="BRO444 Game Disclaimer"
      metaDescription="BRO444 site disclaimer — wagering risk, eligibility, rogue APK mirrors, liability limits."
      ...
      <div className="space-y-6">
        <section aria-labelledby="d1">
          ...
          <p className="mt-2">
            ...
            <strong className="text-foreground">In-app terms, cashier messages, and official notices in the product override
            anything that conflicts here.</strong>
          </p>
        </section>
        ...
        <section aria-labelledby="d2">
          ...
          <p className="mt-2">
            ...
            operator and payment providers.
          </p>
        </section>
        ...
        <section aria-labelledby="d4">
          ...
          <p className="mt-2">
            Third parties may host lookalike pages, APK files, or chat invites. Use only the official download / lobby link
            shown on this authorised BRO444 informational site. We are not responsible for funds or data lost through unofficial
            packages or social channels that pretend to represent the brand.
          </p>
        </section>
        ...
        <section aria-labelledby="d6">
          ...
          <p className="mt-2">
            To the maximum extent allowed by applicable law, the operators of this official website disclaim liability for loss or
            damage arising from reliance on site content — including outages, delays, mistaken copy, phishing by unrelated
            parties, or PSP or device issues — except where liability cannot legally be excluded.
          </p>
        </section>
